...
CONFIG="${ROOT}/configs/scene7_playing_b_joint_av_no_warmup.yaml"
RUN_DIR="${ROOT}/runs/scene7_playing_b_joint_av_no_warmup"
MANIFEST="${ROOT}/runs/scene7_playing_a/scene_manifest.json"
FTGSPP_CHECKPOINT="${ROOT}/runs/scene7_playing_a/ftgspp/Scene7playing/00/gaussians.pt"
